...
{
    public class NhapKhoDLPP_BHModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (result_check.tenSeri != null && result_check.idKho == null)
            {
                Seri.idSeri = idseri;
                Seri.idKho = idkho;
                ...
                Seri.Trangthaisanpham = "Máy nhận bảo hành";
                ...
                ChiTietKho.TrangThaiSanPham = "Máy nhận bảo hành";
                ChiTietKho.SoLuong++;
